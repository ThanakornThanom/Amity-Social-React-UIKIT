               ...
               <div id="sidebar-scrollbar">
                  <nav className="iq-sidebar-menu">
                     <Accordion as="ul" id="iq-sidebar-toggle" className="iq-menu">
                        ...
                        <li className={`${location.pathname === '/dashboards/app/live' || location.pathname === '/dashboards/app/group-detail' ? 'active' : '' }` }>
                           <Link to="/dashboards/app/live" ><i className="las la-users"></i><span>Communities</span></Link>
                        </li>
